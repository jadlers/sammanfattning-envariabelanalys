...
\subsubsection{Förklaring}
Partialbråksuppdelning är en metod för att integrera ${\displaystyle\int_{a}^{b}\frac{p(x)}{q(x)}dx }$ då $p(x)$ och $q(x)$ är polynom.
\subsection{Strategi}
\begin{enumerate}
   ...
   $\frac{p(x)}{q(x)}=\frac{a_{1}}{(x-\alpha_{1})}+\frac{a_{2}}{(x-\alpha_{1})^{2}}+\ldots+\frac{ak_{1}}{(x-\alpha_{1})^{k_{1}}}+\ldots+\frac{b_{1}x+c_{1}}{(x^{2}+\beta_{1}+\gamma_{1})}+\frac{b_{2}x+c_{2}}{(x^2+\beta_{1}+\gamma_{1})^{2}}+\ldots+\frac{b_{l_{1}}x+c_{l_{1}}}{(x^2+\beta_{1}+\gamma_{1})^{l_{1}}}$\\
